...
def _fix_statefulset_conflict(namespace: str = "airflow"):
    ...
    console.print(f"[cyan]  Deleting {len(statefulsets)} StatefulSets at once...[/cyan]")
    # Batch delete statefulsets to reduce Kubernetes API roundtrips
    del_result = _run(
    ...
    if pvcs:
        ...
        # Step B: now the delete completes immediately (no hang). Batch delete PVCs to reduce API roundtrips.
        _run(
